...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}}());hljs.registerLanguage("python",function(){"use strict";return function(e){
const n={
...
begin:/^\.\.\.(?=[ ]|$)/}]}]}}}());hljs.registerLanguage("diff",function(){"use strict";return function(e){return{
